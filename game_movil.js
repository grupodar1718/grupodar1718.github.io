	...
	$("#interfaz").on('click','#bpausaDisabled', function() {
        ...
        pause = true;
				...
				if(parameters ==="ES"){
					...
					$("#divDesglosePunt").append('<ul id="listaReglas"><li type="circle"><p id="pItemsLista_d"><font><img id="life_d" src="Interfaz/dragon.png" align="middle"/>Nivel completado: 500</li><li type="circle"><p id="pItemsLista_d"><font><img id="life_d" src="Interfaz/coin.gif" align="middle"/>Monedas: '+ contMonedas + '</li><li type="circle"><p id="pItemsLista_d"><font><img id="life_d" src="Interfaz/heart.gif"/>Recuento de vidas: ' + contVidas + ' </li></ul>');
					...
					$("#intLevelComplete").append('<div id="divDesglosePunt"></div>');
					$("#divDesglosePunt").append('<ul id="listaReglas"><li type="circle"><p id="pItemsLista_d"><font><img id="life_d" src="Interfaz/dragon.png" align="middle"/>Level completed: 500</li><li type="circle"><p id="pItemsLista_d"><font><img id="life_d" src="Interfaz/coin.gif" align="middle"/>Coins: '+ contMonedas + '</li><li type="circle"><p id="pItemsLista_d"><font><img id="life_d" src="Interfaz/heart.gif"/>Life count: ' + contVidas + ' </li></ul>');
