...
fondoImg.src = "Interfaz/Mapa_movil.png";
...
function sprite (options) {
  ...
  that.checkMove = function(){
    ...
    if(that.xSpeed > 0){
      if (that.xPos > body.offsetWidth * 0.8 - 50){
        die = true;
      }
    }else{
      if(that.xPos <3){
    ...
    if(that.ySpeed > 0){
      if (that.yPos >body.offsetHeight * 0.79965557 - 50){
        die = true;
      }
    }else{
      if(that.yPos <3){
...
canvas.width = body.offsetWidth * 0.8;
canvas.height = body.offsetHeight * 0.8;
...
function checkPosition(pjs){
  ...
  if(pjs.xSpeed < 0 && pjs.xPos >= 3)
    pjs.xPos += pjs.xSpeed;
  if(pjs.ySpeed > 0 && pjs.yPos <= body.offsetHeight * 0.79965557 - 50)
    pjs.yPos += pjs.ySpeed;
...
function createSkeleton(){
  ...
  switch(skeleton.dir){
    case 0:
    	skeleton.xPos = Math.floor((Math.random() * body.offsetWidth * 0.8 - 50));
    	skeleton.ySpeed = 1;
      break;
    case 1:
    	skeleton.xPos = body.offsetWidth * 0.8 - 50;
    	skeleton.yPos = Math.floor((Math.random() * body.offsetHeight * 0.79965557 - 50));
    	skeleton.xSpeed = -1;
      break;
    case 2:
    	skeleton.yPos = Math.floor((Math.random() * body.offsetHeight * 0.79965557 - 50));
      ...
      break;
    case 3:
    	skeleton.ypos = body.offsetHeight * 0.79965557 - 50;
    	skeleton.xPos = Math.floor((Math.random() * body.offsetWidth * 0.8 - 50));
    	skeleton.ySpeed = -1;
      break;      
  }
...
function createVampire(){
  ...
  switch(vampire.dir){
    case 0:
      vampire.xPos = Math.floor((Math.random() * body.offsetWidth * 0.8 - 50));
      vampire.ySpeed = 4;
      break;
    case 1:
      vampire.xPos = body.offsetWidth * 0.8 - 50;
      vampire.yPos = Math.floor((Math.random() * body.offsetHeight * 0.79965557 - 50));
      vampire.xSpeed = -4;
      break;
    case 2:
      vampire.yPos = Math.floor((Math.random() * body.offsetHeight * 0.79965557 - 50));
      ...
      break;
    case 3:
      vampire.ypos = body.offsetHeight * 0.79965557 - 50;
      vampire.xPos = Math.floor((Math.random() * body.offsetWidth * 0.8 - 50));
      vampire.ySpeed = -4;
      break;      
  }
...
function createDemon(){
  ...
  demon.ySpeed = 1.5;
  demon.xSpeed = 1.5;
  demon.xPos = Math.floor((Math.random() * body.offsetWidth * 0.8 - 50));
...
function createfireMob(){
  ...
  switch(fireMob.dir){
    case 0:
      fireMob.xPos = Math.floor((Math.random() * body.offsetWidth * 0.8 - 50));
      fireMob.yPos = 3;
      fireMob.ySpeed = 1;
      break;
    case 1:
      fireMob.xPos = body.offsetWidth * 0.8 - 50;
      fireMob.yPos = Math.floor((Math.random() * body.offsetHeight * 0.79965557 - 50));
      fireMob.xSpeed = -1;
      break;
    case 2:
      fireMob.yPos = Math.floor((Math.random() * body.offsetHeight * 0.79965557 - 50));
      ...
      break;
    case 3:
      fireMob.ypos = body.offsetHeight * 0.79965557 - 50;
      fireMob.xPos = Math.floor((Math.random() * body.offsetWidth * 0.8 - 50));
      fireMob.ySpeed = -1;
      break;      
  }
...
function move(e){
  ...
  if(e.keyCode==39 && pj.xPos<body.offsetWidth * 0.8 - 50){
    pj.xSpeed = speed;
    pj.dir = 2;
  }
  ...
  if(e.keyCode==40 && pj.yPos<body.offsetHeight * 0.79965557 - 50){
    pj.ySpeed = speed;
    pj.dir = 0;
  }
	...
	$("#interfaz").on('click','#bpausaDisabled', function() {
		...
		$("#interfaz").on('click','#breiniciar', function(){
			...
			$("#interfaz").on('click','#bsalirover', function(){
				...
				if(parameters ==="ES"){
					if (music!=="false"){
					$(location).attr('href', 'M_Main.html?ES');
					}
					else{
					$(location).attr('href', 'M_Main.html?ESOFF');
					}					
				}
				else{
					if (music!=="false"){
					$(location).attr('href', 'M_Main.html?EN');
					}
					else{
					$(location).attr('href', 'M_Main.html?ENOFF');
					}
					}
			});
        ...
        pause = true;
				...
				if(parameters ==="ES"){
					...
					$("#divDesglosePunt").append('<ul id="listaReglas"><li type="circle"><p id="pItemsLista_d"><font><img id="life_d" src="Interfaz/Dragon_Logo.png" align="middle"/>Nivel completado: 500</li><li type="circle"><p id="pItemsLista_d"><font><img id="life_d" src="Interfaz/coin.gif" align="middle"/>Monedas: '+ contMonedas + '</li><li type="circle"><p id="pItemsLista_d"><font><img id="life_d" src="Interfaz/heart.gif"/>Recuento de vidas: ' + contVidas + ' </li></ul>');
					...
					$("#intLevelComplete").append('<div id="divDesglosePunt"></div>');
					$("#divDesglosePunt").append('<ul id="listaReglas"><li type="circle"><p id="pItemsLista_d"><font><img id="life_d" src="Interfaz/Dragon_Logo.png" align="middle"/>Level completed: 500</li><li type="circle"><p id="pItemsLista_d"><font><img id="life_d" src="Interfaz/coin.gif" align="middle"/>Coins: '+ contMonedas + '</li><li type="circle"><p id="pItemsLista_d"><font><img id="life_d" src="Interfaz/heart.gif"/>Life count: ' + contVidas + ' </li></ul>');
